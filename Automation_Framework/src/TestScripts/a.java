...
public class a extends SeleniumHelper {
	/*
	 * Author: venky Date: 26/02/2017 TC Description: Verify Different Fields in
	 * Sample Forms Page Comments: Revision History:
	 */
	...
	public void ValidateDifferentFieldsinSampleFormsPage() throws Exception {
		...
		if (!features)
			driver.findElement(By.xpath("//*[@id='header']/ul/li[5]/span")).click();
		...
		boolean login = driver.findElement(By.xpath("//*[@id='center_col']/p[19]/a")).isDisplayed();

		if (!login)
			driver.findElement(By.xpath("//*[@id='center_col']/p[19]/a")).click();

		login = driver.findElement(By.xpath("//*[@id='center_col']/p[19]/a")).isDisplayed();
