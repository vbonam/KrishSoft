...
public class ComplexReportFactory {
	 ...
	 * Author: Hemali
	 * Date: 
	 * Description: This is class contains methods to generate extent reports after test execution 
	 *  	
	 */
	...
	private synchronized static ExtentReports getExtentReport() {
		if (reporter == null) {
			...
			String sResultPath = GlobalVariables.sRunTimeFolderName + "\\RegressionReport.html";			
			reporter = new ExtentReports(sResultPath, true, DisplayOrder.NEWEST_FIRST);
		}
		return reporter;
	}
